          ...
          <div class="col-lg-12">
            ...
            <div class="card-tools">
              ...
              <div class="input-group-append">
                <a href="print.php" class="btn btn-primary" target="blank_"><i class="fas fa-print"></i>print laporan</a>
              </div>
              </div>
            </div>
                </div>
            ...
            <td>    
              <?php if($lelang['status']==''){?>
                ...
                <?php } else if($lelang['status']=='dibuka') {?>
                  -
                <?php } else {?>   
                  <div class="btn btn-success btn-sm">Lelang Selsesai</div>
                <?php } ?>
            </td>
            </tr>
