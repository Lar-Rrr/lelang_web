...
<div class="login-box">
  ...
  <div class="card bg-transparent card-outline ">
    <div class="card-header text-center">
      <p href="#" class="h1 text-white"><b>Login Petugas </b></p>
    </div>
    <div class="card-body">

      <form action="auth_pts.php" method="post">
      ...
      <p class="mb-0 text-white mt-2 h6">
        ...
        <i  class="text-center">Login Masyarakat ? Klik </i> <a href="index.php">Disini</a>
      </p>
...
<?php
    if(isset($_GET['error'])){
      if($_GET['error']=="gagal"){
        ...
        Toast.fire({
          icon: 'warning',
          title: 'masukan username dan password terlebih dahulu'})
        </script>"; 
